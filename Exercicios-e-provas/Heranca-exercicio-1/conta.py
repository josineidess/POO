...
class Conta:
  ...
  @senha.setter #esse método não funcionou quando tentei usar ele para alterar a senha
  def senha(self,nsenha): 
    '''setter para self.__senha'''
    self.__senha = nsenha 

  def alt_senha(self,nsenha): #criei esse pois o setter não funcionou
    '''método simulando setter'''
    self.__senha = nsenha 
